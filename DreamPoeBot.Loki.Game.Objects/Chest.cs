...
public class Chest : NetworkObject
{
	...
	public IEnumerable<ModsDat.ModRecord> ImplicitAffixes
	{
		get
		{
			...
			if (!(component == null))
			{
				foreach (ModsDat.ModRecord affix in component.Affixes)
				{
					if (affix.InternalName.Contains(global::_003CModule_003E.smethod_8<string>(2287812334u)))
					{
						list.Add(affix);
					}
				}
	...
	{
		return base.Type.Equals(global::_003CModule_003E.smethod_9<string>(2642404436u), StringComparison.OrdinalIgnoreCase);
	}

	private bool method_14()
	{
		return base.Type.Contains(global::_003CModule_003E.smethod_7<string>(739622362u));
	}
