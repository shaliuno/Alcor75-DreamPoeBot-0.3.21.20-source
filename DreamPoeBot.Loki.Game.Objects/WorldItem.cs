...
public class WorldItem : NetworkObject
{
	...
	public new string Dump()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(1701621619u)));
		stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_8<string>(2078736419u), HasVisibleHighlightLabel)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(760949110u) + DroppedTime.ToString()));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(2249110249u) + PublicTime.ToString()));
		stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_9<string>(929004460u), HasAllocation)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(4020846150u) + AllocatedToOtherTime.ToString()));
		stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_9<string>(2992460433u), IsAllocatedToOther)));
		if (AllocatedToPlayer != null)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(4092880603u) + AllocatedToPlayer.Name));
		}
		WorldItemLabelClass worldItemLabel = WorldItemLabel;
		if (worldItemLabel != null)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(1242978112u)));
			stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_5<string>(2442034221u), worldItemLabel.Coordinate.X, worldItemLabel.Coordinate.Y)));
			stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_7<string>(336070413u), worldItemLabel.Size.X, worldItemLabel.Size.Y)));
			stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_6<string>(3936520690u), worldItemLabel.IsLabelVisible)));
		}
		else
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(4160279933u)));
		}
		if (!(Item != null))
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(2485818515u)));
		}
		else
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(1021110470u)));
