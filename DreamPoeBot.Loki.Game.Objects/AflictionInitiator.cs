...
public class AflictionInitiator : NetworkObject
{
	...
	public int CurrentWave
	{
		get
		{
			string text = AllStrings.FirstOrDefault((string x) => x.Contains(global::_003CModule_003E.smethod_6<string>(581105066u)));
			if (string.IsNullOrEmpty(text))
			{
				return -1;
			}
			string text2 = text.Replace(global::_003CModule_003E.smethod_8<string>(1930273859u), "");
	...
	public int MaxWave
	{
		get
		{
			string text = AllStrings.FirstOrDefault((string x) => x.Contains(global::_003CModule_003E.smethod_8<string>(988745100u)));
			if (string.IsNullOrEmpty(text))
			{
				return -1;
			}
