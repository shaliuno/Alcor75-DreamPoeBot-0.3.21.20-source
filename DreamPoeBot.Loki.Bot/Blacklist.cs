...
public static class Blacklist
{
	...
	{
		dictionary_0.Clear();
		ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(1667101640u), Array.Empty<object>());
	}
	...
	public static void Add(int id, TimeSpan duration, string reason = "")
	{
		...
		ilog_0.DebugFormat(global::_003CModule_003E.smethod_6<string>(4118739458u), new object[4] { value.int_0, duration, value.dateTime_0, reason });
	}

	public static bool Remove(int id)
	{
		Dictionary<int, Class436> dictionary = Dictionary_0;
		ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(3915627437u), (object)id);
	...
	{
		Dictionary_0.Clear();
		ilog_0.DebugFormat(global::_003CModule_003E.smethod_6<string>(246181206u), Array.Empty<object>());
	}
}
