...
public class GridExplorer : IExplorer, IStartStopEvents, ITickEvents
{
			...
			for (int i = -class441.gridExplorer.TileKnownRadius; i <= class441.gridExplorer.TileKnownRadius; i++)
			{
				for (int j = -class441.gridExplorer.TileKnownRadius; j <= class441.gridExplorer.TileKnownRadius; j++)
				{
					...
					if (i <= class441.gridExplorer.TileSeenRadius && i >= -class441.gridExplorer.TileSeenRadius && j >= -class441.gridExplorer.TileSeenRadius && j <= class441.gridExplorer.TileSeenRadius)
					{
						...
						{
							class441.gridExplorer.GetNodesByFlag(node.Flags).Remove(node);
							node.Flags = Flags.Seen;
							class441.gridExplorer.method_2(cachedTerrainData, class441.myPosition, node, bool_2: false);
							class441.gridExplorer.GetNodesByFlag(node.Flags).Add(node);
						}
					}
					else if (node.Flags == Flags.Unknown)
					{
						class441.gridExplorer.GetNodesByFlag(node.Flags).Remove(node);
						node.Flags = Flags.Known;
						class441.gridExplorer.method_2(cachedTerrainData, class441.myPosition, node, bool_2: true);
						class441.gridExplorer.GetNodesByFlag(node.Flags).Add(node);
					}
				}
			}
	...
	private sealed class Class444
	{
		...
		internal void method_0()
		{
			...
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(2690791483u), Array.Empty<object>());
			for (int i = 0; i < gridExplorer_0.Cols; i++)
			{
				for (int j = 0; j < gridExplorer_0.Rows; j++)
				{
					...
					gridExplorer_0.method_2(cachedTerrainData_0, vector2i_0, node, bool_2: false);
					gridExplorer_0.GetNodesByFlag(node.Flags).Add(node);
				}
			}
			...
			{
				ExamineSpecialAreas();
				if (LokiPoe.ObjectManager.Me.League.Contains(global::_003CModule_003E.smethod_9<string>(225307794u)))
				{
					ilog_0.DebugFormat(global::_003CModule_003E.smethod_7<string>(2405222918u), Array.Empty<object>());
				...
				ilog_0.DebugFormat(global::_003CModule_003E.smethod_7<string>(3193948722u), Array.Empty<object>());
				SacredGroveDataClass sacredGroveData = gridExplorer_0.SacredGroveData;
				if (sacredGroveData.HasSacredGrove)
				{
					ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(4190848929u), Array.Empty<object>());
				...
				ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(4201399621u), Array.Empty<object>());
				IncursionDataClass incursionData = gridExplorer_0.IncursionData;
				if (!incursionData.HasIncursion)
				{
					ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(1966022145u), Array.Empty<object>());
				}
				else
				{
					ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(12202777u), Array.Empty<object>());
			...
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_6<string>(278594210u), (object)stopwatch.Elapsed);
		}

		public void DisableSacredGrove()
		{
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(1844627867u), Array.Empty<object>());
			SacredGroveDataClass sacredGroveData = gridExplorer_0.SacredGroveData;
			int num = 0;
			Node[,] node_ = gridExplorer_0.node_0;
			foreach (Node node in node_)
			{
				if (node.Flags != Flags.Seen && node.Flags != Flags.Ignored && node.Flags != Flags.Disconnected && sacredGroveData.IsInSacredGrove(node.Center.X, node.Center.Y))
				{
					num++;
					gridExplorer_0.ForceNodeFlags(node.Location, Flags.Seen);
				}
			}
			ilog_0.DebugFormat(string.Format(global::_003CModule_003E.smethod_8<string>(3647231147u), num), Array.Empty<object>());
		}

		public void EnableSacredGrove()
		{
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(2839721590u), Array.Empty<object>());
			SacredGroveDataClass sacredGroveData = gridExplorer_0.SacredGroveData;
			int num = 0;
			Node[,] node_ = gridExplorer_0.node_0;
			foreach (Node node in node_)
			...
			ilog_0.DebugFormat(string.Format(global::_003CModule_003E.smethod_9<string>(1804651334u), num), Array.Empty<object>());
		}

		public void DisableIncursion()
		{
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(789634695u), Array.Empty<object>());
			IncursionDataClass incursionData = gridExplorer_0.IncursionData;
			int num = 0;
			Node[,] node_ = gridExplorer_0.node_0;
			foreach (Node node in node_)
			{
				if (node.Flags != Flags.Seen && node.Flags != Flags.Ignored && node.Flags != Flags.Disconnected && incursionData.IsPositionInIncursions(node.Center.X, node.Center.Y))
				{
					num++;
					gridExplorer_0.ForceNodeFlags(node.Location, Flags.Seen);
				}
			}
			ilog_0.DebugFormat(string.Format(global::_003CModule_003E.smethod_5<string>(3379479567u), num), Array.Empty<object>());
		}

		public void EnableIncursion()
		{
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(2685035318u), Array.Empty<object>());
			IncursionDataClass incursionData = gridExplorer_0.IncursionData;
			int num = 0;
			Node[,] node_ = gridExplorer_0.node_0;
			foreach (Node node in node_)
			...
			ilog_0.DebugFormat(string.Format(global::_003CModule_003E.smethod_6<string>(3454765291u), num), Array.Empty<object>());
		}
		...
		private void ExamineSpecialAreas()
		{
			...
			bool flag = LokiPoe.ObjectManager.Me.League.Contains(global::_003CModule_003E.smethod_6<string>(3482100468u));
			for (int i = 0; i < array.GetLength(0); i++)
			{
				for (int j = 0; j < array.GetLength(1); j++)
				{
					...
					if (flag && terrainDataEntry.TgtName.Contains(global::_003CModule_003E.smethod_5<string>(2324386211u)))
					{
						int x = vector2i2.X;
						int y = vector2i2.Y;
					...
					if (terrainDataEntry.TgtName.Contains(global::_003CModule_003E.smethod_9<string>(3209254985u)))
					{
						int x2 = vector2i2.X;
						int y2 = vector2i2.Y;
					...
					if (terrainDataEntry.TgtName != global::_003CModule_003E.smethod_8<string>(3204732838u) && terrainDataEntry.TgtName.Contains(global::_003CModule_003E.smethod_6<string>(3925167484u)))
					{
	...
	public bool AutoResetOnAreaChange
	{
		...
		{
			bool_0 = value;
			ilog_0.InfoFormat(global::_003CModule_003E.smethod_9<string>(616778556u), (object)bool_0);
		}
	}
	...
	public int TileKnownRadius
	{
		...
		set
		{
			...
			ilog_0.InfoFormat(global::_003CModule_003E.smethod_8<string>(442901660u), (object)int_1);
		}
	}
	...
	public int TileSeenRadius
	{
		...
		set
		{
			...
			ilog_0.InfoFormat(global::_003CModule_003E.smethod_6<string>(1943120944u), (object)int_0);
		}
	}
	...
	public void Tick()
	{
		...
		if (Location != Vector2i.Zero)
		{
			...
			if (locationNode == null || locationNode.Flags != Flags.Known)
			{
	...
	private float method_0(Node node_1)
	{
		...
		for (int i = -1; i <= 1; i++)
		{
			for (int j = -1; j <= 1; j++)
			{
				...
				{
					Flags flags = node_0[num3, num4].Flags;
					if (flags != 0)
					{
						num += 1f;
					}
	...
	public Node GetNodeForLocation(Vector2i location)
	{
		...
		{
			ilog_0.ErrorFormat(global::_003CModule_003E.smethod_9<string>(798202984u), (object)location, (object)ex);
		}
		return null;
	}
	...
	public void ForceNodeFlags(Vector2i location, Flags flags)
	{
		try
		{
			...
			{
				GetNodesByFlag(nodeForLocation.Flags).Remove(nodeForLocation);
				nodeForLocation.Flags = flags;
				GetNodesByFlag(nodeForLocation.Flags).Add(nodeForLocation);
				Node locationNode = LocationNode;
				if (locationNode != null && nodeForLocation.Index == locationNode.Index)
				{
					Location = Vector2i.Zero;
					ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(2497272963u), Array.Empty<object>());
				}
			}
		}
		catch (Exception ex)
		{
			ilog_0.ErrorFormat(global::_003CModule_003E.smethod_6<string>(2662391822u), (object)flags, (object)location, (object)ex);
		}
	}
	...
	private void method_2(CachedTerrainData cachedTerrainData_0, Vector2i vector2i_1, Node node_1, bool bool_2)
	{
		method_3(cachedTerrainData_0, vector2i_1, node_1, node_1.NavigableLocation, bool_2);
	}

	private void method_3(CachedTerrainData cachedTerrainData, Vector2i vector2i_1, Node node_1, Vector2i vector2i_0, bool bool_2)
	{
		if (vector2i_0 == default(Vector2i))
		{
			vector2i_0 = node_1.Center;
		}
		bool flag = false;
		if (WalkabilityGrid.IsWalkable(cachedTerrainData.Data, cachedTerrainData.BPR, vector2i_0, cachedTerrainData.Value))
		{
			node_1.NavigableLocation = vector2i_0;
		}
		else
		{
			List<Vector2i> list = new List<Vector2i>();
			for (int i = node_1.Location.X; i < node_1.Location.X + 23; i++)
			{
				for (int j = node_1.Location.Y; j < node_1.Location.Y + 23; j++)
				{
			...
			Vector2i vector2i = (from x in list
				...
				orderby x.DistanceSqr(vector2i_0)
				select x).FirstOrDefault();
			if (vector2i != default(Vector2i))
			{
				node_1.NavigableLocation = vector2i;
			}
			else
			{
				flag = true;
		...
		if (bool_2 && !flag)
		{
			PathfindingCommand command = new PathfindingCommand(vector2i_1, node_1.NavigableLocation, 15f, avoidWallHugging: false);
		...
		if (flag)
		{
			node_1.Flags = Flags.Disconnected;
		}
	}
