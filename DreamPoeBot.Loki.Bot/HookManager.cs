...
internal static class HookManager
{
	...
	internal static void SetMousePosition(Vector2i point)
	{
		...
		{
			Log.WarnFormat(global::_003CModule_003E.smethod_9<string>(4237640702u), Array.Empty<object>());
		}
	...
	internal static void SetKeyState(int key, short state)
	{
		if (!Hooking.IsInstalled)
		{
			Log.WarnFormat(global::_003CModule_003E.smethod_7<string>(2919122745u), Array.Empty<object>());
		}
		else
		{
	...
	internal static short GetKeyState(int key)
	{
		if (!Hooking.IsInstalled)
		{
			Log.WarnFormat(global::_003CModule_003E.smethod_8<string>(2076979389u), Array.Empty<object>());
			return 0;
		}
	...
	internal static void ResetKeyState()
	{
		if (!Hooking.IsInstalled)
		{
			Log.WarnFormat(global::_003CModule_003E.smethod_7<string>(976746137u), Array.Empty<object>());
			return;
		}
	...
	{
		byte[] bytes = Encoding.Unicode.GetBytes(text + global::_003CModule_003E.smethod_8<string>(1387218653u));
	...
	{
		byte[] bytes = Encoding.Unicode.GetBytes(directory + global::_003CModule_003E.smethod_8<string>(1387218653u));
		int data = bytes.Length;
	...
	{
		byte[] bytes = Encoding.Unicode.GetBytes(fileName + global::_003CModule_003E.smethod_9<string>(2032867535u));
		int data = bytes.Length;
	...
	internal static float GetDataFromTheClient()
	{
		...
		Log.WarnFormat(string.Format(global::_003CModule_003E.smethod_9<string>(3235993141u), data2.Y, data2.X, data.ToString(global::_003CModule_003E.smethod_5<string>(3548926522u))), Array.Empty<object>());
