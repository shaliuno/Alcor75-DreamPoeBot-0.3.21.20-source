...
public class TypeLoader<T> : List<T>
{
	...
	private void method_0(params Assembly[] assembly_1)
	{
		foreach (Assembly assembly_2 in assembly_1)
		{
			...
			{
				smethod_8(ilog_0, global::_003CModule_003E.smethod_8<string>(2208066055u), (object)smethod_7(assembly_2), (object)ex);
				if (smethod_9(ex) != null)
				{
					Exception[] array2 = smethod_9(ex);
					foreach (Exception exception_ in array2)
					{
						smethod_10(ilog_0, (object)global::_003CModule_003E.smethod_7<string>(1680380963u), exception_);
					}
				}
			}
			catch (Exception ex2)
			{
				smethod_8(ilog_0, global::_003CModule_003E.smethod_9<string>(1945026653u), (object)smethod_7(assembly_2), (object)ex2);
				if (smethod_11(ex2) != null)
				{
					smethod_10(ilog_0, (object)global::_003CModule_003E.smethod_8<string>(1120539725u), smethod_11(ex2));
				}
			}
		}
	}
