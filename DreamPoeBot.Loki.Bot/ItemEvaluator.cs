...
public static class ItemEvaluator
{
	...
	public static IItemEvaluator Instance
	{
		...
		set
		{
			...
			ilog_0.InfoFormat(global::_003CModule_003E.smethod_5<string>(2224927715u), (object)iitemEvaluator_0.GetType());
		}
	}
	...
	public static bool Match(Item item, EvaluationType type)
	{
		if (Instance == null)
		{
			ilog_0.ErrorFormat(global::_003CModule_003E.smethod_8<string>(3985353121u), Array.Empty<object>());
			return false;
		}
