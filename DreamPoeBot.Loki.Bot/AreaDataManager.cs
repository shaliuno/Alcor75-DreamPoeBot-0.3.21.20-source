...
public class AreaDataManager<T> where T : AreaData
{
	...
	public T Active
	{
		get
		{
			...
			if (!dictionary_0.TryGetValue(areaHash, out var value))
			{
				if (DebugLogging)
				{
					smethod_4(ilog_0, global::_003CModule_003E.smethod_9<string>(2332638501u), (object)smethod_3((MemberInfo)smethod_2(typeof(T).TypeHandle)), (object)areaHash);
				}
	...
	public AreaDataManager(Func<uint, T> allocateFunc)
	{
		...
		{
			throw smethod_1(global::_003CModule_003E.smethod_8<string>(3205056083u));
		}
		func_0 = allocateFunc;
	}
	...
	public void Start()
	{
		...
		foreach (KeyValuePair<uint, T> item in dictionary_0)
		{
			...
			{
				smethod_5(ilog_0, (object)global::_003CModule_003E.smethod_8<string>(63158450u), ex2);
				if (ex == null)
				{
					ex = ex2;
				}
	...
	public void Tick()
	{
		...
		foreach (KeyValuePair<uint, T> item in dictionary_0)
		{
			...
			{
				smethod_5(ilog_0, (object)global::_003CModule_003E.smethod_6<string>(892349493u), ex2);
				if (ex == null)
				{
					ex = ex2;
				}
	...
	public void Stop()
	{
		...
		foreach (KeyValuePair<uint, T> item in dictionary_0)
		{
			...
			{
				smethod_5(ilog_0, (object)global::_003CModule_003E.smethod_6<string>(3846987066u), ex2);
				if (ex == null)
				{
					ex = ex2;
				}
	...
	private void method_0()
	{
		...
		foreach (KeyValuePair<uint, T> item in dictionary_0)
		{
			if (item.Value.Activity.TotalMilliseconds >= (double)DataInactivityExpireTimeMs)
			{
				if (DebugLogging)
				{
					ilog_0.DebugFormat(global::_003CModule_003E.smethod_6<string>(3251037663u), (object)item.Key, (object)item.Value.Activity);
				}
				list.Add(item.Key);
			}
		}
