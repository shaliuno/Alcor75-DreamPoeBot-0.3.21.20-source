...
public class ThirdPartyInstanceWrapper
{
	...
	internal ThirdPartyInstanceWrapper(ThirdPartyInstance instance)
	{
		...
		Bots = method_0(string.Join(global::_003CModule_003E.smethod_6<string>(396436032u), instance.BotInstances.Select(Class17.Class9.method_0)));
		Routines = method_0(string.Join(global::_003CModule_003E.smethod_9<string>(1265206574u), instance.RoutineInstances.Select(Class17.Class9.method_1)));
		Plugins = method_0(string.Join(global::_003CModule_003E.smethod_6<string>(396436032u), instance.PluginInstances.Select(Class17.Class9.method_2)));
		Contents = method_0(string.Join(global::_003CModule_003E.smethod_8<string>(1106314978u), instance.ContentInstances.Select(Class17.Class9.method_3)));
		PlayerMovers = method_0(string.Join(global::_003CModule_003E.smethod_5<string>(1109693591u), instance.PlayerMoverInstances.Select(Class17.Class9.method_4)));
	}
}
