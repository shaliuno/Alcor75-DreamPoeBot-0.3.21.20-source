...
public partial class BotManagerGui : UserControl, IComponentConnector
{
	...
	private void comboBox_0_SelectionChanged(object sender, SelectionChangedEventArgs e)
	{
		try
		{
			...
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(3237342882u), (object)((bot2 != null) ? bot2.Name : global::_003CModule_003E.smethod_5<string>(1182835791u)));
	...
	private void method_1()
	{
		...
		if (CommandLine.Arguments.Exists(global::_003CModule_003E.smethod_6<string>(153113971u)))
		{
			Class1 @class = new Class1();
			@class.string_0 = CommandLine.Arguments.Single(global::_003CModule_003E.smethod_9<string>(1135164145u));
		...
		else if (!string.IsNullOrEmpty(GuiSettings.Instance.LastBot))
		{
			...
			class2.string_0 = GuiSettings.Instance.LastBot;
