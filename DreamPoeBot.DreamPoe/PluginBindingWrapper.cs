	...
	public bool IsEnabled
	{
		...
		set
		{
			...
			if (!PluginManager.IsEnabled(iplugin_0))
			{
				...
				{
					ilog_0.ErrorFormat(global::_003CModule_003E.smethod_8<string>(914575289u), (object)iplugin_0.Name);
				}
			}
			else
			{
				...
				{
					ilog_0.ErrorFormat(global::_003CModule_003E.smethod_7<string>(370830739u), (object)iplugin_0.Name);
				}
			}
