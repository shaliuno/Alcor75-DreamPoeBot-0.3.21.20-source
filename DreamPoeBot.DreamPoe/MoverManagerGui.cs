...
public partial class MoverManagerGui : UserControl, IComponentConnector
{
	...
	private void comboBox_0_SelectionChanged(object sender, SelectionChangedEventArgs e)
	{
		try
		{
			...
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_8<string>(854931669u), (object)((playerMover2 != null) ? playerMover2.Name : global::_003CModule_003E.smethod_7<string>(1826206246u)));
			Configuration.Instance.SaveAll();
		}
		catch (Exception ex)
		{
			ilog_0.Error((object)global::_003CModule_003E.smethod_9<string>(2163549862u), ex);
		}
	}
	...
	private void method_1()
	{
		...
		if (CommandLine.Arguments.Exists(global::_003CModule_003E.smethod_9<string>(3201537157u)))
		{
			Class6 @class = new Class6();
			@class.string_0 = CommandLine.Arguments.Single(global::_003CModule_003E.smethod_8<string>(562936527u));
		...
		else if (!string.IsNullOrEmpty(GuiSettings.Instance.LastMover))
		{
			Class7 class2 = new Class7();
			class2.string_0 = GuiSettings.Instance.LastMover;
