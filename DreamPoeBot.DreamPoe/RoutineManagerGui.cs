...
public partial class RoutineManagerGui : UserControl, IComponentConnector
{
	...
	private void comboBox_0_SelectionChanged(object sender, SelectionChangedEventArgs e)
	{
		try
		{
			...
			ilog_0.DebugFormat(global::_003CModule_003E.smethod_9<string>(103952803u), (object)((routine2 != null) ? routine2.Name : global::_003CModule_003E.smethod_7<string>(1826206246u)));
	...
	private void method_1()
	{
		...
		if (!CommandLine.Arguments.Exists(global::_003CModule_003E.smethod_8<string>(405139530u)))
		{
		...
		else
		{
			...
			class2.string_0 = CommandLine.Arguments.Single(global::_003CModule_003E.smethod_7<string>(1505886774u));
