...
public static class MarshalCache<T>
{
	...
	unsafe static MarshalCache()
	{
		...
		{
			if (smethod_3(smethod_0(typeof(T).TypeHandle)))
			{
		...
		DynamicMethod dynamicMethod = smethod_10(smethod_7(global::_003CModule_003E.smethod_5<string>(2935590291u), smethod_6(smethod_5(smethod_0(typeof(T).TypeHandle)), global::_003CModule_003E.smethod_5<string>(318371219u), global::_003CModule_003E.smethod_6<string>(2829345565u)), global::_003CModule_003E.smethod_5<string>(2125621806u)), smethod_0(typeof(void*).TypeHandle), new Type[1] { smethod_8(smethod_0(typeof(T).TypeHandle)) }, smethod_9(smethod_0(typeof(MarshalCache<>).TypeHandle)));
		...
		foreach (FieldInfo fieldInfo in array)
		{
			...
			if (!(flag = smethod_16((MemberInfo)fieldInfo, smethod_0(typeof(MarshalAsAttribute).TypeHandle), bool_0: true).Any()))
			{
				if (!smethod_2(t, smethod_0(typeof(IntPtr).TypeHandle)) && !smethod_2(t, smethod_0(typeof(string).TypeHandle)))
				{
					...
					if (flag)
					{
						smethod_22(smethod_21(smethod_20((MemberInfo)smethod_19(fieldInfo)), global::_003CModule_003E.smethod_9<string>(674141517u)));
						return true;
					}
				}
				continue;
			}
			smethod_22(smethod_21(smethod_20((MemberInfo)smethod_19(fieldInfo)), global::_003CModule_003E.smethod_8<string>(3195013687u)));
			return true;
		}
		return false;
	}
