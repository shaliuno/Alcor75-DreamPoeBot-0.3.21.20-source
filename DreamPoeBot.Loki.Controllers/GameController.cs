	...
	public async Task WhileLoop()
	{
		...
		while (true)
		{
			...
			if (!(LokiPoe.BotWindow == null || closing))
			{
				...
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_9<string>(1287445918u), Array.Empty<object>());
				break;
			}
			ilog_0.InfoFormat(global::_003CModule_003E.smethod_6<string>(2180951543u), Array.Empty<object>());
			break;
		}
	...
	public async Task RenderLoop()
	{
		...
		while (!ShouldKillRenderLoop)
		{
			if (!(LokiPoe.BotWindow == null || closing))
			{
				...
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_5<string>(2343399952u), Array.Empty<object>());
				break;
			}
			ilog_0.InfoFormat(global::_003CModule_003E.smethod_8<string>(747967407u), Array.Empty<object>());
			break;
		}
	}
}
