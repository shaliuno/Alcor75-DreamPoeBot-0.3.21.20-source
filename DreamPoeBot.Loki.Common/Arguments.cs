...
public class Arguments
{
	...
	public Arguments(IEnumerable<string> arguments)
	{
		...
		Regex regex = new Regex(global::_003CModule_003E.smethod_9<string>(1374106627u), RegexOptions.IgnoreCase | RegexOptions.Compiled);
	...
	private void method_1()
	{
		if (string_0 != null)
		{
			method_4(string_0, global::_003CModule_003E.smethod_9<string>(1548846516u));
			string_0 = null;
		}
	}
	...
	private void method_4(string string_1, string string_2)
	{
		if (dictionary_0.ContainsKey(string_1))
		{
			throw new ArgumentException(string.Format(global::_003CModule_003E.smethod_8<string>(1079241734u), string_1));
		}
		dictionary_0.Add(string_1, new Collection<string>());
		dictionary_0[string_1].Add(string_2);
	}
	...
	{
		method_6(argument);
		return this[argument]?[0].Equals(global::_003CModule_003E.smethod_8<string>(4075141796u), StringComparison.OrdinalIgnoreCase) ?? false;
	}
	...
	private void method_6(string string_1)
	{
		...
		{
			throw new ArgumentException(string.Format(global::_003CModule_003E.smethod_9<string>(1542161977u), string_1));
		}
	}
