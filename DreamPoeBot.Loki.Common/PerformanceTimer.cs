...
public class PerformanceTimer : IDisposable
{
	...
	public void StopAndPrint()
	{
		if (stopwatch_0.IsRunning)
		{
			...
			{
				ilog_0.DebugFormat(string.Format(global::_003CModule_003E.smethod_7<string>(2931751195u), stopwatch_0.Elapsed.TotalMilliseconds, string_0), Array.Empty<object>());
			}
