...
public struct BoundingBox : IEquatable<BoundingBox>
{
	...
	public void GetCorners(Vector3[] corners)
	{
		if (corners == null)
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_8<string>(21537214u));
		}
		if (corners.Length < 8)
		{
			throw new ArgumentOutOfRangeException(global::_003CModule_003E.smethod_6<string>(853259284u));
		}
		corners[0].X = Min.X;
		corners[0].Y = Max.Y;
		corners[0].Z = Max.Z;
	...
	{
		return string.Format(CultureInfo.CurrentCulture, global::_003CModule_003E.smethod_9<string>(3612302489u), new object[2]
		{
			Min.ToString(),
			Max.ToString()
		});
