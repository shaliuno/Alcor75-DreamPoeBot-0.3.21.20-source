...
public sealed class AsyncAppender : IAppender, IBulkAppender, IOptionHandler, IAppenderAttachable
{
	...
	public AsyncAppender(Func<int> getDropRepeatMessageDelayMs)
	{
		...
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_8<string>(4210734058u));
		}
	...
	public void AddAppender(IAppender newAppender)
	{
		...
		if (newAppender == null)
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_7<string>(267407454u));
		}
		lock (this)
		{
			if (appenderAttachedImpl_0 == null)
