...
public static class Hotkeys
{
	...
	private static void ProcessHotkeyLoop()
	{
		if (thread == null)
		{
			...
			{
				Name = global::_003CModule_003E.smethod_7<string>(3300509291u),
				IsBackground = true
			};
			thread.Start();
		}
	...
	private static void smethod_4()
	{
		...
		while (PeekMessage(out msg_0, IntPtr.Zero, 786u, 786u, 1u))
		{
			...
			if (hotkey != null)
			{
				ilog_0.DebugFormat(hotkey.Name + global::_003CModule_003E.smethod_8<string>(736614164u), Array.Empty<object>());
