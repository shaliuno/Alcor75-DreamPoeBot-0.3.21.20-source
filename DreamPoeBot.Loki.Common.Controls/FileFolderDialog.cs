...
public class FileFolderDialog : CommonDialog
{
	...
	public string SelectedPath
	{
		get
		{
			try
			{
				if (openFileDialog_0.FileName != null && (openFileDialog_0.FileName.EndsWith(global::_003CModule_003E.smethod_6<string>(3673446707u)) || !File.Exists(openFileDialog_0.FileName)) && !Directory.Exists(openFileDialog_0.FileName))
				{
			...
			if (openFileDialog_0.FileNames != null && openFileDialog_0.FileNames.Length > 1)
			{
				...
				foreach (string text in fileNames)
				{
					try
					{
						if (File.Exists(text))
						{
							stringBuilder.Append(text + global::_003CModule_003E.smethod_8<string>(3009697263u));
						}
					}
					catch (Exception)
					{
	...
	public new DialogResult ShowDialog(IWin32Window owner)
	{
		...
		openFileDialog_0.FileName = global::_003CModule_003E.smethod_9<string>(598608689u);
		if (owner == null)
		{
