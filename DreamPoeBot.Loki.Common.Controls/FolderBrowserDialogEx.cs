...
public class FolderBrowserDialogEx : CommonDialog
{
	...
	public Environment.SpecialFolder RootFolder
	{
		...
		set
		{
			...
			{
				throw new InvalidEnumArgumentException(global::_003CModule_003E.smethod_5<string>(1163822050u), (int)value, typeof(Environment.SpecialFolder));
			}
	...
	{
		int_1 += 8192;
		Description = global::_003CModule_003E.smethod_8<string>(4146584842u);
	...
	{
		int_1 += 4096;
		Description = global::_003CModule_003E.smethod_5<string>(353853565u);
	...
	private int method_2(IntPtr intptr_2, int int_2, IntPtr intptr_3, IntPtr intptr_4)
	{
		...
		case 1:
			if (string_1.Length != 0)
			{
				...
				if (bool_4 && bool_5)
				{
					intptr_0 = Class417.Class420.FindWindowEx(new HandleRef(null, intptr_2), IntPtr.Zero, global::_003CModule_003E.smethod_7<string>(3404890850u), null);
	...
	protected override bool RunDialog(IntPtr hWndOwner)
	{
		...
		if (intptr_1 == IntPtr.Zero)
		{
			...
			if (intptr_1 == IntPtr.Zero)
			{
				...
				if (intptr_1 == IntPtr.Zero)
				{
					throw new InvalidOperationException(global::_003CModule_003E.smethod_5<string>(2513769525u));
				}
			}
		}
		intptr_0 = IntPtr.Zero;
		...
		{
			throw new ThreadStateException(global::_003CModule_003E.smethod_5<string>(632131268u));
		}
