	...
	public Dictionary<Element, KeyValuePair<long, ushort>> SkillsDictionary
	{
		get
		{
			...
			foreach (Element skillsElement in SkillsElements)
			{
				...
				if (num == 0L)
				{
					Skill skill = LokiPoe.ObjectManager.Me.Components.ActorComponent.AvailableSkills.FirstOrDefault((Skill x) => x.Name == global::_003CModule_003E.smethod_8<string>(3447366731u));
					if (!(skill == null))
					{
