...
public class InstanceManager : Element
{
	...
	public Element MyInstance
	{
		get
		{
			List<Element> source = FindElementWithText(global::_003CModule_003E.smethod_8<string>(3261465286u));
			if (!source.Any())
			{
				return null;
			}
	...
	public Element NewInstance
	{
		get
		{
			List<Element> source = FindElementWithText(global::_003CModule_003E.smethod_6<string>(1266139031u));
			if (source.Any())
			{
				return source.FirstOrDefault();
			}
	...
	public Vector2i NewInstanceClickPosition
	{
		get
		{
			if (NewInstance == null)
			{
				throw new Exception(global::_003CModule_003E.smethod_6<string>(3997017361u));
			}
	...
	{
		List<Element> list = FindElementWithText(global::_003CModule_003E.smethod_6<string>(471539827u));
		return list.Count;
	}
