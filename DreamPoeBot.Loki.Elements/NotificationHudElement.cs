...
public class NotificationHudElement : Element
{
	public class NotificationInfo
	{
		...
		public LokiPoe.InGameState.NotificationType NotificationTypeEnum
		{
			get
			{
				...
				{
					if (Type.Equals(global::_003CModule_003E.smethod_9<string>(3311498234u)))
					{
					...
					else if (Type.Equals(LokiPoe.InGameState.NotificationHud.LocalCache.FriendInviteNotification, StringComparison.OrdinalIgnoreCase))
					{
						_notificationTypeEnum = LokiPoe.InGameState.NotificationType.Friend;
					}
					else if (!Type.Equals(LokiPoe.InGameState.NotificationHud.LocalCache.PvPNotificationStatusMessageYou, StringComparison.OrdinalIgnoreCase))
					{
						if (GuildName != "")
						{
	...
	private string NotificationType(Element element)
	{
		...
		{
			return global::_003CModule_003E.smethod_7<string>(2907931706u);
		}
