	...
	public class Recipe
	{
		public class Price
		{
			...
			public int GetQuantity(int idx)
			{
				...
				if (int.TryParse(element.Text.Replace(global::_003CModule_003E.smethod_6<string>(263731011u), "").Replace(global::_003CModule_003E.smethod_8<string>(1710630029u), "").Replace(global::_003CModule_003E.smethod_9<string>(4247480578u), ""), out var result))
				{
					return result;
				}
				return -1;
			...
			public string GetCurrency(int idx)
			{
				...
				return LokiPoe.Memory.ReadNativeString(addr).Replace(global::_003CModule_003E.smethod_5<string>(2511278585u), "").Replace(global::_003CModule_003E.smethod_7<string>(1794561937u), "");
			}
		}
		...
		public int Level
		{
			get
			{
				try
				{
					...
					if (int.TryParse(element.Text.Replace(global::_003CModule_003E.smethod_6<string>(2410044688u), ""), out var result))
					{
						return result;
					}
					return -1;
