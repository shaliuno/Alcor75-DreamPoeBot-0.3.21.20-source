...
public class SubterainChartElement : Element
{
	...
	public class DelveNode : Element
	{
		...
		public bool SelectIcon()
		{
			...
			while (parent.Address != 0L && parent.IdLabel != global::_003CModule_003E.smethod_6<string>(1715000820u))
			{
	...
	internal Element VisitMineEncampment
	{
		get
		{
			...
			{
				Element element = LokiPoe.FindTextInElementChildrens(item, global::_003CModule_003E.smethod_6<string>(2556249870u));
				if (element != null)
				{
					return element;
				}
	...
	internal Element VisitTheMine
	{
		get
		{
			...
			foreach (Element item in enumerable)
			{
				Element element = LokiPoe.FindTextInElementChildrens(item, global::_003CModule_003E.smethod_8<string>(1903200615u));
				if (element != null)
				{
					return element;
				}
