...
public class DatIncursionRoomsWrapper
{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(string.Format(global::_003CModule_003E.smethod_5<string>(350117155u), Index, AreaId, Id, Name, Tier, Description, Lore) + ((UpgradedRoom != null) ? string.Format(global::_003CModule_003E.smethod_6<string>(1553471568u), UpgradedRoom.Id, UpgradedRoom.Name) : "") + ((IncursionArchitect != null) ? string.Format(global::_003CModule_003E.smethod_5<string>(2804887234u), IncursionArchitect.MonsterId, IncursionArchitect.Metadata, IncursionArchitect.Name) : "")));
