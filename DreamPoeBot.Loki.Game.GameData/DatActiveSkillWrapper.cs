...
public class DatActiveSkillWrapper
{
	...
	private void method_0(ActiveSkills struct289_1)
	{
		...
		foreach (int num in array)
		{
			...
			if (num < 0 || num > 23)
			{
				throw new Exception(string.Format(global::_003CModule_003E.smethod_6<string>(1083069375u), num));
			}
		}
		...
		foreach (long item in list)
		{
			...
			throw new Exception(global::_003CModule_003E.smethod_7<string>(2479122857u) + text + global::_003CModule_003E.smethod_5<string>(318371219u));
		}
	}
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(2863063716u), Index));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(2285338087u), InternalId));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3456912640u), DisplayName));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3452111851u), InternalName));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(3164162914u), BaseInternalName));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1599405789u), Icon));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3488121873u), LongDescription));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(4212852165u), AmazonLink));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(1259544136u), string.Join(global::_003CModule_003E.smethod_8<string>(1106314978u), CastTypes)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(1181281408u), string.Join(global::_003CModule_003E.smethod_5<string>(1109693591u), SkillTypes)));
		List<DatStatWrapper> skillStats = SkillStats;
		if (skillStats.Any())
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(3643372041u)));
			foreach (DatStatWrapper item in skillStats)
			{
				stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(3127752992u), item.Id));
			}
		}
		skillStats = BaseStats;
		if (skillStats.Any())
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(3272377569u)));
			foreach (DatStatWrapper item2 in skillStats)
			{
				stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(2169274092u), item2.Id));
			}
		}
		if (_53.Any())
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(60169483u), string.Join(global::_003CModule_003E.smethod_6<string>(396436032u), _53)));
		}
