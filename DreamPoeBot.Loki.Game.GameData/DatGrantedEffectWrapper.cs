...
public class DatGrantedEffectWrapper
{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(1683864681u), BaseAddress));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(4237788663u), Name));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(2143679073u), CastTime));
		if (SupportLetter != string.Empty)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(1690397053u), SupportLetter));
		}
		if (SupportAffectsSkillGem)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(1168373848u), SupportAffectsSkillGem));
		}
