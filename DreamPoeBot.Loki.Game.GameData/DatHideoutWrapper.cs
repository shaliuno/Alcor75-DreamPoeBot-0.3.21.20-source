...
public class DatHideoutWrapper
{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(3868697967u), Id));
		if (WorldArea1 != null)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1807568373u), WorldArea1));
		}
		else
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(947238006u)));
		}
