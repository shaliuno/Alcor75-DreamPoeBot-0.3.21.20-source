...
public class DatModsWrapper
{
	...
	internal struct Struct316
	{
		...
		private readonly byte byte_38;

		private readonly byte byte_351;

		private readonly byte byte_361;

		private readonly byte byte_371;

		private readonly byte byte_381;

		private readonly byte byte_362;

		private readonly byte byte_372;

		private readonly byte byte_382;
	}
	...
	public override string ToString()
	{
		...
		string format = global::_003CModule_003E.smethod_8<string>(3406514923u);
		stringBuilder2.AppendLine(string.Format(format, Level, Category, InternalName, DisplayName, ModType, TypeName, string.Join(global::_003CModule_003E.smethod_5<string>(2892912620u), Stats.Select(Class376.Class9.method_0)), string.Join(global::_003CModule_003E.smethod_5<string>(2892912620u), Tags), TierString));
