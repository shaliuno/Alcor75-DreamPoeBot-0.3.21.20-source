...
public class DatSkillGemWrapper
{
	...
	internal DatSkillGemWrapper(long address, Struct324 native, int index)
	{
		...
		if (list_0.Contains(global::_003CModule_003E.smethod_5<string>(2705428738u)))
		{
			SocketColor = SocketColor.Blue;
		}
		else if (list_0.Contains(global::_003CModule_003E.smethod_5<string>(3777098510u)))
		{
			SocketColor = SocketColor.Green;
		}
		else if (list_0.Contains(global::_003CModule_003E.smethod_7<string>(167292341u)))
		{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(1352596032u), BaseItemTypeWrapper.Name, SupportsText, SocketColor.ToString(), string.Join(global::_003CModule_003E.smethod_8<string>(2520425632u), Tags), Address.ToString(global::_003CModule_003E.smethod_6<string>(2756242974u))));
