...
public struct Vector3 : IEquatable<Vector3>
{
	...
	{
		return string.Format(CultureInfo.InvariantCulture, global::_003CModule_003E.smethod_8<string>(1060572860u), X, Y, Z);
	}
	...
	public static Vector3 CubiceHermiteCurve(Vector3 start, Vector3 end, Vector3 u, Vector3 v, float t)
	{
		if (t > 1f || t < 0f)
		{
			throw new ArgumentOutOfRangeException(global::_003CModule_003E.smethod_8<string>(4056472922u), global::_003CModule_003E.smethod_9<string>(1004390404u));
		}
		float num = 1f - t;
		float num2 = t * t;
		float num3 = num * num;
	...
	public static Vector3 Blend(Vector3 firstPoint, Vector3 secondPoint, float t)
	{
		if (t > 1f || t < 0f)
		{
			throw new ArgumentOutOfRangeException(global::_003CModule_003E.smethod_6<string>(3131261608u), global::_003CModule_003E.smethod_5<string>(303308929u));
		}
		float num = 1f - t;
