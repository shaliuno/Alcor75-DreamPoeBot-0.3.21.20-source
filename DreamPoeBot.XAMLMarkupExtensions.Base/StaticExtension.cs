...
internal class StaticExtension : NestedMarkupExtension, INotifyPropertyChanged
{
	...
	public Type MemberType
	{
		...
		set
		{
			...
			{
				type_0 = value;
				RaisePropertyChanged(global::_003CModule_003E.smethod_8<string>(3358224546u));
			}
		}
	}
	...
	public string Member
	{
		...
		set
		{
			...
			{
				string_0 = value;
				RaisePropertyChanged(global::_003CModule_003E.smethod_8<string>(70329342u));
			}
		}
	}
	...
	public object Result
	{
		...
		set
		{
			...
			{
				object_0 = value;
				RaisePropertyChanged(global::_003CModule_003E.smethod_6<string>(1061528971u));
			}
		}
	}
	...
	protected override void OnServiceProviderChanged(IServiceProvider serviceProvider)
	{
		if (string_0 != null && !(string_0.Trim() == ""))
		{
			...
			if (!(type_0 == null) && !(text.Trim() == ""))
			{
				...
				if (!(property != null))
				{
					...
					if (field == null)
					{
						throw new InvalidOperationException(global::_003CModule_003E.smethod_7<string>(3128352740u) + text + global::_003CModule_003E.smethod_8<string>(1369396576u) + type_0.FullName);
					}
				...
				else
				{
					if (!property.CanRead)
					{
						throw new InvalidOperationException(global::_003CModule_003E.smethod_8<string>(2164927764u) + text + global::_003CModule_003E.smethod_8<string>(1872932622u));
					}
		...
		throw new InvalidOperationException(global::_003CModule_003E.smethod_5<string>(3279967456u));
	}
