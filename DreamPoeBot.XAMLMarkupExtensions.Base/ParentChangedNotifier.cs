...
{
	public static DependencyProperty ParentProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_8<string>(2708690929u), typeof(DependencyObject), typeof(ParentChangedNotifier), new PropertyMetadata(smethod_0));
	...
	public ParentChangedNotifier(FrameworkElement element, Action onParentChanged)
	{
		...
		Binding binding = new Binding(global::_003CModule_003E.smethod_9<string>(1834544827u));
