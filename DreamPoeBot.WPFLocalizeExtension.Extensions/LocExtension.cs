...
internal class LocExtension : NestedMarkupExtension, IDisposable, INotifyPropertyChanged, IDictionaryEventListener
{
	...
	public string Key
	{
		...
		set
		{
			if (string_0 != value)
			{
				string_0 = value;
				UpdateNewValue();
				method_2(global::_003CModule_003E.smethod_9<string>(1970119357u));
			}
		}
	}
	...
	public string ResourceIdentifierKey
	{
		get
		{
			return string_0 ?? global::_003CModule_003E.smethod_9<string>(437567590u);
		}
		set
		{
			string_0 = value;
	...
	private static string smethod_2(object object_2)
	{
		...
		{
			if (object_2 is DependencyProperty)
			{
		...
		if (text.Contains(global::_003CModule_003E.smethod_7<string>(2569642970u)))
		{
			text = global::_003CModule_003E.smethod_9<string>(3522724741u);
		}
		else if (text.Contains(global::_003CModule_003E.smethod_7<string>(1204091764u)))
		{
			text = global::_003CModule_003E.smethod_7<string>(3840566245u);
		}
		else if (text.Contains(global::_003CModule_003E.smethod_6<string>(1381274512u)))
		{
			text = global::_003CModule_003E.smethod_6<string>(287587739u);
		}
		return text;
	}
	...
	protected CultureInfo GetForcedCultureOrDefault()
	{
		if (!string.IsNullOrEmpty(ForceCulture))
		{
			...
			catch (ArgumentException innerException)
			{
				...
				{
					throw new ArgumentException(global::_003CModule_003E.smethod_6<string>(2324304633u) + ForceCulture + global::_003CModule_003E.smethod_8<string>(3593687547u), innerException);
				}
	...
	public override object FormatOutput(TargetInfo endPoint, TargetInfo info)
	{
		...
		{
			if (endPoint.TargetObject is FrameworkContentElement)
			{
		...
		string text3 = forcedCultureOrDefault.Name + global::_003CModule_003E.smethod_9<string>(1251106184u) + type.Name + global::_003CModule_003E.smethod_5<string>(1872002525u);
		...
		if (string.IsNullOrEmpty(fullyQualifiedResourceKey))
		{
			...
			else
			{
				...
				else if (flag && dictionary_1.ContainsKey(text3 + fullyQualifiedResourceKey3))
				{
		...
		if (obj == null)
		{
			...
			else
			{
				...
				{
					obj = global::_003CModule_003E.smethod_5<string>(912846296u) + string_0;
				}
			}
		}
		return obj;
	...
	public static TValue GetLocalizedValue<TValue>(string key, CultureInfo targetCulture, DependencyObject target, IValueConverter converter = null, object converterParameter = null)
	{
		...
		FullyQualifiedResourceKeyBase fullyQualifiedResourceKey = LocalizeDictionary.Instance.GetFullyQualifiedResourceKey(key, target);
		string text = targetCulture.Name + global::_003CModule_003E.smethod_9<string>(1251106184u) + typeof(TValue).Name + global::_003CModule_003E.smethod_8<string>(2969470144u) + fullyQualifiedResourceKey;
		bool flag;
	...
	public bool ResolveLocalizedValue<TValue>(out TValue resolvedValue, CultureInfo targetCulture, DependencyObject target)
	{
		...
		FullyQualifiedResourceKeyBase fullyQualifiedResourceKey = LocalizeDictionary.Instance.GetFullyQualifiedResourceKey(Key, target);
		string text = targetCulture.Name + global::_003CModule_003E.smethod_5<string>(1872002525u) + typeof(TValue).Name + global::_003CModule_003E.smethod_6<string>(1084412678u) + fullyQualifiedResourceKey;
		bool flag;
		if ((flag = Converter is DefaultConverter) && dictionary_1.ContainsKey(text))
		{
	...
	public bool SetBinding(object targetObject, object targetProperty, int targetPropertyIndex)
	{
		...
		else if (@class.object_1 is PropertyInfo)
		{
	...
	{
		return global::_003CModule_003E.smethod_5<string>(1714526573u) + string_0;
	}
