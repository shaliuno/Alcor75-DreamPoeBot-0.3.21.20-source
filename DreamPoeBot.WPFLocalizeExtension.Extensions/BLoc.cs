...
internal class BLoc : Binding, IDisposable, INotifyPropertyChanged, IDictionaryEventListener
{
	...
	public object Value
	{
		...
		set
		{
			...
			{
				object_1 = value;
				method_0(global::_003CModule_003E.smethod_6<string>(4087043400u));
			}
		}
	}
	...
	public string Key
	{
		...
		set
		{
			if (string_0 != value)
			{
				string_0 = value;
				method_1();
				method_0(global::_003CModule_003E.smethod_8<string>(3487917095u));
			}
		}
	}
	...
	public BLoc()
	{
		...
		base.Path = new PropertyPath(global::_003CModule_003E.smethod_8<string>(1141550650u));
		base.Source = this;
	}
	...
	protected CultureInfo GetForcedCultureOrDefault()
	{
		if (!string.IsNullOrEmpty(ForceCulture))
		{
			...
			catch (ArgumentException innerException)
			{
				...
				{
					throw new ArgumentException(global::_003CModule_003E.smethod_7<string>(329795845u) + ForceCulture + global::_003CModule_003E.smethod_7<string>(1690818143u), innerException);
				}
	...
	public object FormatOutput()
	{
		...
		string text2 = forcedCultureOrDefault.Name + global::_003CModule_003E.smethod_7<string>(2781543372u);
		object obj;
