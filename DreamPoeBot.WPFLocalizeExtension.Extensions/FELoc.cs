...
internal class FELoc : FrameworkElement, IDisposable, INotifyPropertyChanged, IDictionaryEventListener
{
	...
	public static readonly DependencyProperty KeyProperty = DependencyProperty.Register(global::_003CModule_003E.smethod_8<string>(3487917095u), typeof(string), typeof(FELoc), new PropertyMetadata(null, smethod_2));

	public static readonly DependencyProperty ConverterProperty = DependencyProperty.Register(global::_003CModule_003E.smethod_5<string>(634568593u), typeof(IValueConverter), typeof(FELoc), new PropertyMetadata(new DefaultConverter(), smethod_2));

	public static readonly DependencyProperty ConverterParameterProperty = DependencyProperty.Register(global::_003CModule_003E.smethod_8<string>(3125873024u), typeof(object), typeof(FELoc), new PropertyMetadata(null, smethod_2));

	public static readonly DependencyProperty ForceCultureProperty = DependencyProperty.Register(global::_003CModule_003E.smethod_9<string>(2843818802u), typeof(string), typeof(FELoc), new PropertyMetadata(null, smethod_2));
	...
	public object Content
	{
		...
		{
			object_1 = value;
			method_0(global::_003CModule_003E.smethod_9<string>(3872204519u));
		}
	}
	...
	protected CultureInfo GetForcedCultureOrDefault()
	{
		if (!string.IsNullOrEmpty(ForceCulture))
		{
			...
			catch (ArgumentException innerException)
			{
				...
				{
					throw new ArgumentException(global::_003CModule_003E.smethod_8<string>(3885682689u) + ForceCulture + global::_003CModule_003E.smethod_7<string>(1690818143u), innerException);
				}
	...
	public object FormatOutput()
	{
		...
		if (!text3.Contains(global::_003CModule_003E.smethod_8<string>(346019462u)))
		{
			if (text3.Contains(global::_003CModule_003E.smethod_9<string>(1459268768u)))
			{
				text3 = global::_003CModule_003E.smethod_7<string>(3840566245u);
			}
			else if (text3.Contains(global::_003CModule_003E.smethod_5<string>(3409057415u)))
			{
				text3 = global::_003CModule_003E.smethod_6<string>(287587739u);
			}
		}
		else
		{
			text3 = global::_003CModule_003E.smethod_5<string>(3147356128u);
		}
		string text4 = forcedCultureOrDefault.Name + global::_003CModule_003E.smethod_5<string>(1872002525u) + type.Name + global::_003CModule_003E.smethod_9<string>(1251106184u);
	...
	private void method_5()
	{
		...
		foreach (DependencyProperty item in method_2(parent))
		{
			if (parent.GetValue(item) == this)
			{
				...
				BindingOperations.SetBinding(parent, item, new Binding(global::_003CModule_003E.smethod_5<string>(3670758702u))
				{
					Source = this,
					Converter = Converter,
