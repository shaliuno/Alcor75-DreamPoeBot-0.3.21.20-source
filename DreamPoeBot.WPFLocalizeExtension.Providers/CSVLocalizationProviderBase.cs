...
internal abstract class CSVLocalizationProviderBase : DependencyObject, ILocalizationProvider
{
	...
	protected string GetAssemblyName(Assembly assembly)
	{
		if (assembly == null)
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_5<string>(3221950000u));
		}
		if (assembly.FullName == null)
		{
			throw new NullReferenceException(global::_003CModule_003E.smethod_9<string>(733571056u));
		}
	...
	public static void ParseKey(string inKey, out string outAssembly, out string outDict, out string outKey)
	{
		...
		{
			string[] array = inKey.Trim().Split(global::_003CModule_003E.smethod_6<string>(1084412678u).ToCharArray());
			if (array.Length == 3)
			{
	...
	{
		throw new InvalidOperationException(global::_003CModule_003E.smethod_6<string>(3815291008u));
	}
}
