...
{
	public static readonly DependencyProperty DefaultDictionaryProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_7<string>(1898189637u), typeof(string), typeof(InheritingResxLocalizationProvider), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, smethod_1));

	public static readonly DependencyProperty DefaultAssemblyProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_7<string>(2087445499u), typeof(string), typeof(InheritingResxLocalizationProvider), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, smethod_1));
