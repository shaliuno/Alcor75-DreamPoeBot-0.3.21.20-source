...
internal abstract class ResxLocalizationProviderBase : DependencyObject, ILocalizationProvider
{
	...
	private sealed class Class79
	{
		...
		{
			return (int)(uint)managementObject_0[global::_003CModule_003E.smethod_9<string>(3005189613u)];
		}
		...
		{
			return new Class70<Process, string, string>(class69_0.p, (string)class69_0.mo[global::_003CModule_003E.smethod_9<string>(598938401u)], (string)class69_0.mo[global::_003CModule_003E.smethod_8<string>(3739685118u)]);
		}
	...
	private sealed class Class81
	{
		...
		internal bool method_0(string string_1)
		{
			return string_0.StartsWith(string_1 + global::_003CModule_003E.smethod_6<string>(887988612u));
		}
	}
	...
	protected string GetAssemblyName(Assembly assembly)
	{
		if (assembly == null)
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_6<string>(3244451047u));
		}
		if (assembly.FullName == null)
		{
			throw new NullReferenceException(global::_003CModule_003E.smethod_7<string>(438010500u));
		}
	...
	public static void ParseKey(string inKey, out string outAssembly, out string outDict, out string outKey)
	{
		...
		{
			string[] array = inKey.Trim().Split(global::_003CModule_003E.smethod_9<string>(1251106184u).ToCharArray());
			if (array.Length == 3)
			{
	...
	private static string smethod_0(int int_0)
	{
		...
		{
			using (ManagementObjectSearcher managementObjectSearcher = new ManagementObjectSearcher(global::_003CModule_003E.smethod_5<string>(1078610456u)))
			{
	...
	private bool method_0(string string_2, string string_3)
	{
		...
		{
			if (!string_2.EndsWith(global::_003CModule_003E.smethod_9<string>(2635656218u), StringComparison.OrdinalIgnoreCase) && !string_2.EndsWith(global::_003CModule_003E.smethod_5<string>(2125415604u), StringComparison.OrdinalIgnoreCase) && !string_2.EndsWith(global::_003CModule_003E.smethod_5<string>(260353763u), StringComparison.OrdinalIgnoreCase))
			{
	...
	protected ResourceManager GetResourceManager(string resourceAssembly, string resourceDictionary)
	{
		...
		string text = null;
		string text2 = global::_003CModule_003E.smethod_9<string>(4247480578u) + resourceDictionary + global::_003CModule_003E.smethod_7<string>(3754996130u);
		string thekey = resourceAssembly + text2;
		DateTime now = DateTime.Now;
		if (AppDomain.CurrentDomain.FriendlyName.Contains(global::_003CModule_003E.smethod_9<string>(2971766918u)) && (now - dateTime_0).TotalSeconds >= 1.0)
		{
			dateTime_0 = now;
			string path = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), global::_003CModule_003E.smethod_5<string>(1062034040u));
			Process[] processes = Process.GetProcesses();
			foreach (Process process in processes)
			{
				Class80 @class = new Class80();
				@class.resxLocalizationProviderBase_0 = this;
				if (!process.ProcessName.Contains(global::_003CModule_003E.smethod_5<string>(522055050u)))
				{
					continue;
				}
				@class.string_0 = Path.GetDirectoryName(smethod_0(process.Id));
				if (string.IsNullOrEmpty(@class.string_0) || Directory.GetFiles(@class.string_0, resourceAssembly + global::_003CModule_003E.smethod_9<string>(3489302046u), SearchOption.AllDirectories).Length == 0)
				{
					continue;
				}
				string[] array = Directory.GetFiles(@class.string_0, global::_003CModule_003E.smethod_6<string>(3367772522u), SearchOption.AllDirectories).Where(@class.method_0).ToArray();
				TryRemove(thekey);
				string[] array2 = array;
				foreach (string text3 in array2)
				{
					try
					{
						string text4 = Path.Combine(path, text3.Replace(@class.string_0 + global::_003CModule_003E.smethod_8<string>(3316603310u), ""));
				...
				string text5 = Path.Combine(path, resourceAssembly + global::_003CModule_003E.smethod_5<string>(3924171781u));
				if (!File.Exists(text5))
				{
					text5 = Path.Combine(path, resourceAssembly + global::_003CModule_003E.smethod_5<string>(1240853247u));
				}
		...
		if (!TryGetValue(thekey, out var result))
		{
			if (assembly == null)
			{
				...
				{
					throw new Exception(string.Format(global::_003CModule_003E.smethod_9<string>(3502671124u), resourceAssembly), innerException);
				}
			}
			...
			for (int k = 0; k < array3.Length; k++)
			{
				...
				if (text != null)
				{
					text = text.Substring(0, text.Length - global::_003CModule_003E.smethod_7<string>(3754996130u).Length);
					Type type;
					try
					{
				...
				if (result == null)
				{
					throw new ArgumentException(string.Format(global::_003CModule_003E.smethod_8<string>(824239294u), resourceDictionary, resourceAssembly));
				}
				Add(thekey, result);
				try
				{
	...
	private ResourceManager method_1(Type type_0)
	{
		...
		try
		{
			return (ResourceManager)type_0.GetProperty(global::_003CModule_003E.smethod_8<string>(28708106u), BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).GetGetMethod(nonPublic: true).Invoke(null, null);
		}
		catch
		{
			return null;
	...
	public virtual object GetLocalizedObject(string key, DependencyObject target, CultureInfo culture)
	{
		...
		if (!string.IsNullOrEmpty(outAssembly))
		{
			if (string.IsNullOrEmpty(outDict))
			{
				OnProviderError(target, key, global::_003CModule_003E.smethod_9<string>(928364562u));
				return null;
			}
			if (string.IsNullOrEmpty(key))
			{
				OnProviderError(target, key, global::_003CModule_003E.smethod_9<string>(4194946141u));
				return null;
			}
			...
			{
				OnProviderError(target, key, global::_003CModule_003E.smethod_9<string>(3334615774u) + ex.Message);
				return null;
			}
			return resourceManager.GetObject(key, culture);
		}
		OnProviderError(target, key, global::_003CModule_003E.smethod_7<string>(1880074005u));
		return null;
	}
}
