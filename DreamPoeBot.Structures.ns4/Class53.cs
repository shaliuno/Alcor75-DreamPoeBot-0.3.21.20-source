	...
	public void imethod_0(Stream stream_0, Stream stream_1, long long_0, long long_1, Interface0 interface0_0)
	{
		...
		while (num5 < (ulong)long_1)
		{
			...
			if (struct9_0[(@struct.uint_0 << 4) + num6].method_2(class64_0) == 0)
			{
				...
				byte byte_3 = ((!@struct.method_5()) ? class55_0.method_4(class64_0, (uint)num5, byte_2, class62_0.method_7(num)) : class55_0.method_3(class64_0, (uint)num5, byte_2));
			...
			if (struct9_1[@struct.uint_0].method_2(class64_0) != 1)
			{
				...
				num3 = num2;
				num2 = num;
				num7 = 2 + class54_0.method_2(class64_0, num6);
				@struct.method_2();
				uint num8 = struct11_0[Class52.smethod_0(num7)].method_1(class64_0);
				if (num8 >= 4)
				{
					...
					if (num8 >= 14)
					{
						num += class64_0.method_7(num9 - 4) << 4;
						num += struct11_1.method_2(class64_0);
					}
					else
					{
						num += Struct11.smethod_0(struct9_6, num - num8 - 1, class64_0, num9);
					}
				}
				else
				{
			...
			else
			{
				...
				else if (struct9_5[(@struct.uint_0 << 4) + num6].method_2(class64_0) == 0)
				{
					@struct.method_4();
				...
				num7 = class54_1.method_2(class64_0, num6) + 2;
				@struct.method_3();
			}
			if (num < num5 && num < uint_1)
			{
				class62_0.method_5(num, num7);
				num5 += num7;
				continue;
			}
