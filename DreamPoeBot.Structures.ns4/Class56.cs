...
internal class Class56 : Interface1, Interface2, Interface3
{
	...
	static Class56()
	{
		...
		{
			global::_003CModule_003E.smethod_6<string>(2025217064u),
			global::_003CModule_003E.smethod_7<string>(3196286360u)
		};
		int num = 2;
		byte_0[0] = 0;
		byte_0[1] = 1;
		...
		while ((ulong)num < (ulong)object_0.Length)
		{
			while (true)
			{
				...
				while (true)
				{
					...
					int num3 = ((int)num2 * -1013525158) ^ -14961091;
					while (true)
					{
						switch ((num2 = (uint)num3 ^ 0x6E884195u) % 63u)
						{
						case 31u:
							num3 = (int)(num2 * 1223751813) ^ -1326546987;
							continue;
						default:
							return;
						case 43u:
