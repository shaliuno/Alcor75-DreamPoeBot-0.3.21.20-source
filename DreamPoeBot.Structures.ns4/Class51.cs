...
internal class Class51 : Class50, Interface5, Interface6
{
	...
	public void imethod_8(uint uint_26)
	{
		do
		{
			...
			if (bool_1)
			{
				uint num4 = Class49.uint_0[byte_0[num3]] ^ byte_0[num3 + 1];
				uint num5 = num4 & 0x3FFu;
				uint_18[num5] = uint_5;
				uint num6 = num4 ^ (uint)(byte_0[num3 + 2] << 8);
				uint num7 = num6 & 0xFFFFu;
				uint_18[1024 + num7] = uint_5;
				num8 = (num6 ^ (Class49.uint_0[byte_0[num3 + 3]] << 5)) & uint_19;
			}
			else
			{
				num8 = (uint)(byte_0[num3] ^ (byte_0[num3 + 1] << 8));
			}
			uint num9 = uint_18[uint_23 + num8];
			uint_18[uint_23 + num8] = uint_5;
