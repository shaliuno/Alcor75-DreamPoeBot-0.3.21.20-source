...
internal static class Class61
{
	...
	private static readonly object[] object_0 = new object[8]
	{
		8388608,
		2,
		3,
		...
		2,
		128,
		global::_003CModule_003E.smethod_5<string>(3882730741u),
		false
	};
	...
	public static byte[] smethod_3(Stream stream_0)
	{
		...
		{
			throw new Exception(global::_003CModule_003E.smethod_7<string>(3683012739u));
		}
		long num = 0L;
		for (int i = 0; i < 8; i++)
		{
			...
			throw new Exception(global::_003CModule_003E.smethod_7<string>(852753488u));
		}
