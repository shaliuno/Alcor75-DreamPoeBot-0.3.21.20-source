...
public class ServerData : RemoteMemoryObject
{
	...
	public IEnumerable<ushort> SkillBarIds
	{
		get
		{
			SkillbarStruct ids = StructServerData_0.SkillbarIds;
	...
	internal StructServerData StructServerData_0
	{
		get
		{
			if (perFrame_StructServerData == null)
			{
				perFrame_StructServerData = new PerFrameCachedValue<StructServerData>(GetServerData);
			}
			return perFrame_StructServerData.Value;
		}
	}
	...
	internal StructServerDataExtra ServerDataExtra
	{
		get
		{
			if (perFrameCachedValue_ServerDataExtra == null)
			{
				perFrameCachedValue_ServerDataExtra = new PerFrameCachedValue<StructServerDataExtra>(GetServerDataExtraStructure);
			}
			return perFrameCachedValue_ServerDataExtra.Value;
		}
	}

	internal StructAtlasDataExtra ServerAtlasDataExtra
	{
		get
		{
			if (perFrameCachedValue_ServerAtlasDataExtra == null)
			{
				perFrameCachedValue_ServerAtlasDataExtra = new PerFrameCachedValue<StructAtlasDataExtra>(GetServerAtlasDataExtraStructure);
			}
			return perFrameCachedValue_ServerAtlasDataExtra.Value;
		}
	}
