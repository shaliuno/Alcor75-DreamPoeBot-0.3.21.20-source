...
public class Aura : RemoteMemoryObject
{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(865607988u)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(659926992u), base.Address));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(2485544958u), Name));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(3635699801u), InternalName));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(1263302879u), Description));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(779274261u), CasterId));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(512736413u), OwnerId));
		Skill skill = LokiPoe.ObjectManager.Me.AvailableSkills.FirstOrDefault((Skill x) => x.Id == SkillOwnerId);
		if (skill != null)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(3065906159u), SkillOwnerId, skill.Name, skill.InternalName, skill.InternalId));
		}
		else
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(691629348u), SkillOwnerId));
		}
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(4131211436u), BuffType));
		...
		if (flaskSlot != -1)
		{
			...
			if (!(item != null))
			{
				stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(3560371475u), flaskSlot));
			}
			else
			{
				stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1850830944u), flaskSlot, item.Name, item.FullName));
			}
		}
		else
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(1077078189u), flaskSlot));
		}
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(14198463u), TimeLeft));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(1385727221u), MaxTimeLeft));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1689460133u), Charges));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(4022201702u), StacksPct, Stacks, MaxStacks));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(824166948u), IsPlagueActive));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1185294083u), IsInvisible));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(4254532911u), IsRemovable));
