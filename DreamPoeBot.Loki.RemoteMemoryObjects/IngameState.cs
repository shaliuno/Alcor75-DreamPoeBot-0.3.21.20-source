...
public class IngameState : RemoteMemoryObject
{
	...
	internal long IngameUIElementsAddress => base.M.ReadLong(base.Address + 1104L + base.Offsets.IgsOffset);

	public IngameUIElements IngameUi => ReadObjectAt<IngameUIElements>(1104 + base.Offsets.IgsOffset);

	public Element UIRoot => ReadObjectAt<Element>(416 + base.Offsets.IgsOffset);

	public Element UIHover => ReadObjectAt<Element>(472 + base.Offsets.IgsOffset);

	public float UIHoverX => base.M.ReadFloat(base.Address + 480L + base.Offsets.IgsOffset);

	public float UIHoverY => base.M.ReadFloat(base.Address + 484L + base.Offsets.IgsOffset);

	public Element UIHoverTooltip => ReadObjectAt<Element>(488 + base.Offsets.IgsOffset);

	public float TimeInGameF => base.M.ReadFloat(base.Address + 1040L + base.Offsets.IgsOffset);

	public DiagnosticInfoType DiagnosticInfoType => (DiagnosticInfoType)base.M.ReadInt(base.Address + 1552L + base.Offsets.IgsOffset);
