...
public static class MouseManager
{
		...
		while (enumerator.MoveNext())
		{
			while (true)
			{
				...
				while (true)
				{
					...
					int num4 = (int)((num3 * 533200378) ^ 0x1D3C0B76);
					while (true)
					{
						switch ((num3 = (uint)num4 ^ 0x4D1959F0u) % 15u)
						{
						case 12u:
							num4 = (int)((num3 * 779250032) ^ 0x25E66E72);
							continue;
						case 11u:
							break;
						case 1u:
	...
	internal static void OnInternalPreMove(string reason, int posX, int posY)
	{
		if (LogEvents)
		{
			ilog_0.Warn((object)string.Format(global::_003CModule_003E.smethod_5<string>(4237116442u), reason, posX, posY));
		}
