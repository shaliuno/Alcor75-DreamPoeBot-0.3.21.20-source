...
public class BaseItemTypes : FileInMemory
{
	...
	public BaseItemType Translate(string metadata)
	{
		...
		{
			Console.WriteLine(global::_003CModule_003E.smethod_9<string>(1825738240u) + metadata);
			return null;
		}
		return value;
	}
	...
	private void LoadItemTypes()
	{
		...
		foreach (long item in enumerable)
		{
			...
			if (array.Length > 3)
			{
				...
				{
					string text2 = Regex.Replace(array[j], global::_003CModule_003E.smethod_6<string>(1275041971u), global::_003CModule_003E.smethod_6<string>(3062890180u)).ToLower().Remove(0, 1);
