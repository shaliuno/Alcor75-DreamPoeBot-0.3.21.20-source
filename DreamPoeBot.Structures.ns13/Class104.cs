...
internal class Class104
{
	...
	private sealed class Class105
	{
		...
		internal void method_4()
		{
				...
				while (true)
				{
					if (!string.IsNullOrEmpty(Class41.clientIdent))
					{
						while (true)
						{
							...
							{
								ilog_0.ErrorFormat(global::_003CModule_003E.smethod_5<string>(2782674976u), (object)ex.ToString());
							}
						}
					}
					else
					{
						ilog_0.InfoFormat(global::_003CModule_003E.smethod_5<string>(91068234u), Array.Empty<object>());
						Thread.Sleep(1000);
					}
				}
			}
			...
			{
				ilog_0.ErrorFormat(global::_003CModule_003E.smethod_8<string>(4150644255u), (object)ex2.ToString());
			}
		...
		internal bool method_5(Class41 class41_0)
		{
			...
			if (!(r.Body == global::_003CModule_003E.smethod_9<string>(872062625u)) && !r.Body.ToLower().Contains(global::_003CModule_003E.smethod_6<string>(627991252u)) && !r.Body.ToLower().Contains(global::_003CModule_003E.smethod_7<string>(3642731704u)))
			{
				if (r.Success)
				{
					if (!string.IsNullOrEmpty(r.Body) && r.Body[0] == 'T')
					{
						ilog_0.ErrorFormat(global::_003CModule_003E.smethod_9<string>(4138644204u), Array.Empty<object>());
						class41_0.ClientIdent = null;
						return false;
					}
					return true;
				}
				ilog_0.ErrorFormat(global::_003CModule_003E.smethod_5<string>(3094105511u), (object)r.Body);
				ilog_0.ErrorFormat(global::_003CModule_003E.smethod_9<string>(1396282292u), (object)text);
				ilog_0.ErrorFormat(global::_003CModule_003E.smethod_8<string>(4256414707u), (object)class41_0.ClientIdent);
				class41_0.ClientIdent = null;
				return false;
			}
			return true;
	...
	private sealed class Class106
	{
		...
		internal bool method_0(Class41 class41_0)
		{
			try
			{
				class41_0.method_6();
				string text = smethod_3(class41_0);
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_9<string>(18416797u), (object)text);
				long num = DateTime.UtcNow.ToBinary();
				d0 d = class41_0.method_5(StringCdKey, 10, num);
				string_0 = d.Body;
				if (!d.Success)
				{
					ilog_0.ErrorFormat(global::_003CModule_003E.smethod_8<string>(746573290u), (object)d.Body);
					return false;
				}
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_9<string>(3453053726u), (object)d.Info);
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_8<string>(3344707758u), (object)num, (object)d.Body);
				return true;
			}
			catch (Exception ex)
			{
				ilog_0.Error((object)global::_003CModule_003E.smethod_9<string>(1913817420u), ex);
	...
	private static bool smethod_1()
	{
		try
		{
			...
			{
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_9<string>(3238206603u), Array.Empty<object>());
				Thread.Sleep(500);
	...
	private static void smethod_2()
	{
		try
		{
			...
			{
				ilog_0.InfoFormat(global::_003CModule_003E.smethod_9<string>(495844691u), Array.Empty<object>());
				LokiPoe.EscapeState.LogoutError logoutError = LokiPoe.EscapeState.LogoutToTitleScreen();
				ilog_0.DebugFormat(global::_003CModule_003E.smethod_7<string>(803414637u), (object)logoutError);
			}
		}
		catch
		{
	...
	private static string smethod_3(Class41 class41_0)
	{
		...
		try
		{
			...
			{
				return string.Format(global::_003CModule_003E.smethod_9<string>(1026748897u), Class41.Region_0, Dns.GetHostAddresses(uri.Host).FirstOrDefault(Class105.Class9.method_1));
			}
			return string.Format(global::_003CModule_003E.smethod_5<string>(3600931669u), Class41.Region_0, uri.Host);
		}
		catch (Exception arg)
		{
			return string.Format(global::_003CModule_003E.smethod_6<string>(2838248505u), uri.Host, arg);
		}
	}
