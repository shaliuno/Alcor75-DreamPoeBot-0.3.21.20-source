...
public class LabyrinthRoom
{
	...
	public class LabyrinthSection
	{
		...
		public override string ToString()
		{
			...
			{
				text = global::_003CModule_003E.smethod_8<string>(810399261u) + string.Join(global::_003CModule_003E.smethod_9<string>(1043976889u), Overrides.Select((LabyrinthSectionOverrides x) => x.ToString()).ToArray());
			}
			return global::_003CModule_003E.smethod_7<string>(4121358541u) + SectionType + global::_003CModule_003E.smethod_9<string>(1043976889u) + text;
		}
	}
	...
	public override string ToString()
	{
		...
		if (list.Count > 0)
		{
			text = global::_003CModule_003E.smethod_9<string>(2811429396u) + string.Join(global::_003CModule_003E.smethod_5<string>(2892912620u), list.Select((LabyrinthRoom x) => x.Id.ToString()).ToArray());
		}
		return string.Format(global::_003CModule_003E.smethod_5<string>(313819421u), Id) + string.Format(global::_003CModule_003E.smethod_9<string>(1258824012u), (Secret1 == null) ? global::_003CModule_003E.smethod_8<string>(1102394403u) : Secret1.SecretName, (Secret2 == null) ? global::_003CModule_003E.smethod_7<string>(3932102679u) : Secret2.SecretName, text, Section);
	}
}
