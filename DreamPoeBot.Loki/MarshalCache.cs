...
public static class MarshalCache<T>
{
	...
	unsafe static MarshalCache()
	{
		...
		SizeU = (uint)Size;
		string text = global::_003CModule_003E.smethod_8<string>(765989791u);
		Type type2 = smethod_0(typeof(T).TypeHandle);
		Debug.Write(text + (((object)type2 != null) ? smethod_6((object)type2) : null) + global::_003CModule_003E.smethod_9<string>(2828565974u) + SizeU);
		...
		DynamicMethod dynamicMethod = new DynamicMethod(string.Format(global::_003CModule_003E.smethod_6<string>(3971025487u), typeof(T).FullName.Replace(global::_003CModule_003E.smethod_7<string>(2542469522u), global::_003CModule_003E.smethod_8<string>(1269525837u))), typeof(void*), new Type[1] { typeof(T).MakeByRefType() }, typeof(MarshalCache<>).Module);
