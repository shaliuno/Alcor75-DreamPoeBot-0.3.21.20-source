...
public class GlobalSettings : JsonSettings
{
	...
	public static Crypto Crypto = new Crypto(Encoding.ASCII.GetBytes(global::_003CModule_003E.smethod_7<string>(1984238889u)));
	...
	public bool HookCompatibility0
	{
		...
		set
		{
			if (!value.Equals(bool_18))
			{
				...
				ilog_1.WarnFormat(global::_003CModule_003E.smethod_7<string>(3061377394u), Array.Empty<object>());
				Save();
			}
		}
	}
	...
	public Region AuthRegion
	{
		...
		set
		{
			if (!value.Equals(region_0))
			{
				...
				ilog_1.InfoFormat(global::_003CModule_003E.smethod_6<string>(648649224u), (object)region_0);
				Save();
			}
		}
	}
	...
	public GlobalSettings()
		: base(JsonSettings.GetSettingsFilePath(global::_003CModule_003E.smethod_5<string>(2683216480u), CommandLine.Arguments.Exists(global::_003CModule_003E.smethod_8<string>(91139960u)) ? CommandLine.Arguments.Single(global::_003CModule_003E.smethod_9<string>(3588628256u)) : global::_003CModule_003E.smethod_8<string>(3736573639u)))
	{
		if (string.IsNullOrEmpty(_lastUsedConfiguration))
		{
			_lastUsedConfiguration = global::_003CModule_003E.smethod_7<string>(2768435785u);
		}
	...
	internal void method_0(StreamingContext streamingContext_0)
	{
		...
		{
			AuthKeys = Crypto.EncryptStringAes(AuthKeys, global::_003CModule_003E.smethod_9<string>(1881336600u));
		}
	}
	...
	internal void method_1(StreamingContext streamingContext_0)
	{
		if (!string.IsNullOrEmpty(AuthKeys))
		{
			AuthKeys = Crypto.DecryptStringAes(AuthKeys, global::_003CModule_003E.smethod_8<string>(4018163472u));
		}
	}
