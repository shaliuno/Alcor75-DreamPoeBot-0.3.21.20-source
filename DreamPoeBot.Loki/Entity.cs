...
public abstract class Entity : RemoteMemoryObject
{
	...
	public string Metadata
	{
		...
		{
			string text = Type;
			int num = text.IndexOf(global::_003CModule_003E.smethod_7<string>(4075590324u), StringComparison.Ordinal);
			if (num != -1)
			{
	...
	public string Name
	{
		get
		{
			try
			{
				...
				{
					return global::_003CModule_003E.smethod_5<string>(635814063u);
				}
				return metadata;
			}
			catch (Exception)
			{
				return global::_003CModule_003E.smethod_7<string>(366506246u);
			}
		}
	}
