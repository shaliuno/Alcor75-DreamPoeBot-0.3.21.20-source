...
public class Crypto
{
	...
	public string EncryptStringAes(string plainText, string sharedSecret)
	{
		...
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_5<string>(2953205975u));
		}
		...
		throw new ArgumentNullException(global::_003CModule_003E.smethod_8<string>(383135102u));
	}
	...
	public string DecryptStringAes(string cipherText, string sharedSecret)
	{
		...
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_9<string>(2721613350u));
		}
		if (string.IsNullOrEmpty(sharedSecret))
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_6<string>(2288066516u));
		}
		RijndaelManaged rijndaelManaged = null;
		try
		{
	...
	private static byte[] smethod_0(Stream stream_0)
	{
		...
		{
			throw new SystemException(global::_003CModule_003E.smethod_7<string>(1912255498u));
		}
		byte[] array2 = new byte[BitConverter.ToInt32(array, 0)];
		if (stream_0.Read(array2, 0, array2.Length) != array2.Length)
		{
			throw new SystemException(global::_003CModule_003E.smethod_8<string>(4280336804u));
		}
		return array2;
	}
}
