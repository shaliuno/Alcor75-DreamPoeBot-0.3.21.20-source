...
public class Configuration
{
	...
	public void SaveAll()
	{
		...
		{
			ilog_0.Error((object)global::_003CModule_003E.smethod_8<string>(423362221u), ex);
		}
		foreach (JsonSettings item in list_0.ToList())
		{
			...
			{
				ilog_0.ErrorFormat(global::_003CModule_003E.smethod_8<string>(2225965501u), (object)item.FilePath, (object)ex2);
			}
		}
