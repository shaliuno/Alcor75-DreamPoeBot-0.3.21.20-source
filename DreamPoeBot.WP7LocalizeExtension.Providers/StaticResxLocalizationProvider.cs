...
{
	public static readonly DependencyProperty DefaultDictionaryProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_8<string>(2506161217u), typeof(string), typeof(StaticResxLocalizationProvider), new PropertyMetadata(null, smethod_1));

	public static readonly DependencyProperty DefaultAssemblyProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_9<string>(726886517u), typeof(string), typeof(StaticResxLocalizationProvider), new PropertyMetadata(null, smethod_1));
