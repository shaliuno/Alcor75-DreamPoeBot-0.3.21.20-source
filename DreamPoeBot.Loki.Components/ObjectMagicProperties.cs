...
public class ObjectMagicProperties : Component
{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(992045581u)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(971150537u)));
		foreach (string impMod in ImpMods)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(2835718182u), impMod));
		}
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(887117331u)));
		foreach (string expMod in ExpMods)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1145890426u), expMod));
		}
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3888252338u)));
		foreach (ModsDat.ModRecord affix in Affixes)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(2941488634u), affix.InternalName, affix.DisplayName));
			...
			foreach (StatsDat.StatRecord statRecord in statNames)
			{
				if (statRecord != null)
				{
					...
					{
						stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(1750521991u), "", statRecord.StatTypeGGG));
					}
					else
					{
						stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(2234246352u), value, statRecord.StatTypeGGG));
					}
				}
			}
		}
