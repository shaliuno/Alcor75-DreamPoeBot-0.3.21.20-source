...
public class Stats : Component
{
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(550389474u)));
		foreach (KeyValuePair<StatTypeGGG, int> item in StatsD)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(1652826322u), item.Key.ToString(), item.Value));
		}
