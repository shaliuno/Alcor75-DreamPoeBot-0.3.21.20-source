...
public class Actor : Component
{
	public class ActionWrapper : RemoteMemoryObject
	{
		...
		public override string ToString()
		{
			...
			stringBuilder.AppendFormat(global::_003CModule_003E.smethod_8<string>(1482907041u), Destination);
			stringBuilder.AppendLine();
			if (Target != null)
			{
				stringBuilder.AppendFormat(global::_003CModule_003E.smethod_7<string>(798943776u), Target.Id);
				stringBuilder.AppendLine();
			}
			if (Skill != null)
			{
				stringBuilder.AppendFormat(global::_003CModule_003E.smethod_8<string>(449164286u), Skill.InternalId);
				stringBuilder.AppendLine();
			}
	...
	public override string ToString()
	{
		_ = Struct137_0;
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(174044944u), global::_003CModule_003E.smethod_7<string>(2087982683u)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(1878294936u), Flags));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(2459711140u), TimeSinceLastMove));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3593429045u), TimeSinceLastAction));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(1480995334u), HasCurrentAction));
		if (HasCurrentAction)
		{
			ActionWrapper currentAction = CurrentAction;
			stringBuilder.AppendLine(global::_003CModule_003E.smethod_5<string>(1951201810u));
			if (currentAction != null)
			{
				stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(4121268628u), currentAction.Skill.InternalName, currentAction.Skill.Name));
				stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(779754867u), currentAction.Destination));
				if (!object.Equals(currentAction.Target, null))
				{
					stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(1303785787u), currentAction.Target.Id, currentAction.Target.Name, currentAction.Target.Metadata));
				}
				else
				{
					stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(1523134160u)));
				}
			}
		}
		stringBuilder.AppendLine(global::_003CModule_003E.smethod_8<string>(1628904612u));
		foreach (Skill availableSkill in AvailableSkills)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(979370995u), availableSkill.InternalName, availableSkill.Name));
		}
		stringBuilder.AppendLine(global::_003CModule_003E.smethod_9<string>(2710923013u));
		foreach (NetworkObject deployedObject in DeployedObjects)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(1850592646u), deployedObject.Id, deployedObject.Name, deployedObject.Metadata));
		}
		return stringBuilder.ToString();
	}
}
