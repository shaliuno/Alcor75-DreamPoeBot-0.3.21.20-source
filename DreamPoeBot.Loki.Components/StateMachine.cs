...
public class StateMachine : Component
{
	...
	public bool IsRitualActive
	{
		get
		{
			...
			return stageStates.FirstOrDefault((StageState x) => x.Name == global::_003CModule_003E.smethod_5<string>(3513121324u))?.IsActive ?? false;
		}
	}
	...
	public bool Encounter_Started
	{
		...
		{
			List<StageState> stageStates = StageStates;
			return stageStates.FirstOrDefault((StageState x) => x.Name == global::_003CModule_003E.smethod_9<string>(459358073u))?.IsActive ?? false;
		}
	}
	...
	public bool Encounter_Finished
	{
		...
		{
			List<StageState> stageStates = StageStates;
			return stageStates.FirstOrDefault((StageState x) => x.Name == global::_003CModule_003E.smethod_8<string>(2862428513u))?.IsActive ?? false;
		}
	}
