...
public class Player : Component
{
	public class TrialState
	{
		...
		{
			return string.Format(global::_003CModule_003E.smethod_5<string>(90906808u), IsCompleted, TrialAreaName, TrialAreaId);
		}
	}
	...
	internal struct Struct189
	{
		...
		public new string ToString()
		{
			...
			stringBuilder.AppendFormat(global::_003CModule_003E.smethod_6<string>(3785013150u), int_0CurExp);
			stringBuilder.AppendFormat(global::_003CModule_003E.smethod_7<string>(3273335843u), int_1MaxExp);
			stringBuilder.AppendFormat(global::_003CModule_003E.smethod_6<string>(259535616u), int_2);
			stringBuilder.AppendFormat(global::_003CModule_003E.smethod_6<string>(681944660u), int_3);
	...
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(1098658235u)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_8<string>(3193256657u)));
		foreach (TrialState item in TrialStatesDegug(byte0Offset))
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3209346399u), item.TrialAreaName, item.IsCompleted));
		}
		return stringBuilder.ToString();
	}
	...
	{
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3041291049u)));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_7<string>(3296401473u), Name));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(3905707064u), Level));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_6<string>(3591665707u), HasHideout));
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(3837606906u)));
		foreach (TrialState item in TrialStatesDegug(global::_003CModule_003E.smethod_6<string>(3788436437u)))
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_9<string>(3209346399u), item.TrialAreaName, item.IsCompleted));
		}
		stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(3314204332u)));
		foreach (DreamPoeBot.Loki.Game.Objects.Prophecy prophecy in Prophecies)
		{
			stringBuilder.AppendLine(string.Format(global::_003CModule_003E.smethod_5<string>(3444907389u), prophecy.DatPropheciesWrapper.Name));
		}
		return stringBuilder.ToString();
	}
