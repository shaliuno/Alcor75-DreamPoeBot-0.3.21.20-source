...
internal class Class41
{
	...
	public static void smethod_0(Region region_1)
	{
		...
		{
			String_1 = null;
			arg = global::_003CModule_003E.smethod_8<string>(2491250312u);
		}
		else
		{
			String_1 = smethod_1(region_1);
			arg = string.Format(global::_003CModule_003E.smethod_9<string>(4255106992u), String_1);
		}
		endpointAddress_0 = new EndpointAddress(string.Format(global::_003CModule_003E.smethod_9<string>(2541130797u), arg));
	}
	...
	private static string smethod_1(Region region_1)
	{
		...
		{
			Region.Europe => global::_003CModule_003E.smethod_9<string>(988525413u), 
			Region.NorthAmerica => global::_003CModule_003E.smethod_8<string>(648419913u), 
			Region.China => global::_003CModule_003E.smethod_9<string>(2877241497u), 
			Region.SoutheastAsia => global::_003CModule_003E.smethod_6<string>(1328829893u), 
			_ => throw new ArgumentOutOfRangeException(global::_003CModule_003E.smethod_8<string>(3644319975u)), 
		};
	}

	private static Region smethod_2(string string_4)
	{
		string text = string_4.ToLowerInvariant();
		if (text == global::_003CModule_003E.smethod_8<string>(250654319u))
		{
			return Region.Europe;
		}
		if (!(text == global::_003CModule_003E.smethod_5<string>(2458189394u)))
		{
			if (!(text == global::_003CModule_003E.smethod_6<string>(2892918859u)))
			{
				if (!(text == global::_003CModule_003E.smethod_7<string>(3863210785u)))
				{
					throw new ArgumentOutOfRangeException(global::_003CModule_003E.smethod_6<string>(3861058422u));
				}
	...
	public d0 GetProd(string id)
	{
		...
		if (!string.IsNullOrEmpty(d.Body) && d.Body == global::_003CModule_003E.smethod_7<string>(50440960u))
		{
	...
	public d0 GetProdList()
	{
		...
		if (!string.IsNullOrEmpty(d.Body) && d.Body == global::_003CModule_003E.smethod_9<string>(141564124u))
		{
			eventHandler_1?.Invoke(null, null);
		}
		if (d.Success)
	...
	public d0 GetTimeLeft()
	{
		...
		if (!string.IsNullOrEmpty(d.Body) && d.Body == global::_003CModule_003E.smethod_6<string>(4283467466u))
		{
			eventHandler_1?.Invoke(null, null);
		}
		_ = d.Success;
	...
	{
		string text = Class42.smethod_2(global::_003CModule_003E.smethod_6<string>(4084817665u));
	...
	public r0 method_6()
	{
		if (!method_4())
		{
			...
			{
				Success = false,
				Body = global::_003CModule_003E.smethod_5<string>(1091665503u)
			};
		}
	...
	public d0 method_7(string string_4, string string_5, bool bool_0 = false)
	{
		if (!method_4())
		{
			...
			{
				Success = false,
				Body = global::_003CModule_003E.smethod_9<string>(3233405814u)
			};
		}
	...
	public unsafe r0 method_10(params object[] object_0)
	{
		if (method_4() && (stopwatch_0 == null || stopwatch_0.Elapsed.TotalMinutes <= 5.0))
		{
			...
			if (byte_0 != null)
			{
				...
				{
					ilog_0.InfoFormat(string.Format(global::_003CModule_003E.smethod_9<string>(1001894491u), byte_0.Length), Array.Empty<object>());
					method_8();
				}
				byte[] array;
				byte* ptr2;
				...
				rSACryptoServiceProvider.FromXmlString(global::_003CModule_003E.smethod_9<string>(2386444525u));
				RSAPKCS1SignatureDeformatter rSAPKCS1SignatureDeformatter = new RSAPKCS1SignatureDeformatter(rSACryptoServiceProvider);
				rSAPKCS1SignatureDeformatter.SetHashAlgorithm(global::_003CModule_003E.smethod_8<string>(2921625950u));
		...
		{
			Success = false,
			Body = global::_003CModule_003E.smethod_6<string>(3886167864u)
		};
	}
	...
	public d0 method_11(string string_4, byte byte_1 = 2)
	{
		...
		if (!string.IsNullOrEmpty(d.Body) && d.Body == global::_003CModule_003E.smethod_5<string>(2703314265u))
		{
			eventHandler_1?.Invoke(null, null);
		}
		return d;
	...
	public d0 method_13(WoWNpc[] woWNpc_0)
	{
		...
		if (!string.IsNullOrEmpty(d.Body) && d.Body == global::_003CModule_003E.smethod_8<string>(104656748u))
		{
			eventHandler_1?.Invoke(null, null);
		}
		return d;
	...
	public d0 method_16(string string_4, byte byte_1 = 2)
	{
		if (!method_4())
		{
			...
			{
				Success = false,
				Body = global::_003CModule_003E.smethod_7<string>(1808090614u)
			};
		}
		string_4 += ((byte_1 == 2) ? global::_003CModule_003E.smethod_7<string>(3313558831u) : "");
	...
	public r0 method_19(UsageInfo usageInfo_0)
	{
		...
		if (!string.IsNullOrEmpty(r.Body) && r.Body == global::_003CModule_003E.smethod_7<string>(50440960u))
		{
			eventHandler_1?.Invoke(null, null);
		}
		return r;
	...
	public r0 method_22(string string_4, string string_5, string string_6, int int_0)
	{
		if (!method_4())
		{
			...
			{
				Success = false,
				Body = global::_003CModule_003E.smethod_8<string>(3100556810u)
			};
		}
