...
internal class Class42
{
	...
	private sealed class Class43
	{
		...
		{
			return byte_0.ToString(global::_003CModule_003E.smethod_6<string>(2319853163u));
		}

		internal string method_1(string string_0, byte byte_0)
		{
			return string_0 + byte_0.ToString(global::_003CModule_003E.smethod_8<string>(3888470923u));
		}
	}
	...
	public static byte[] smethod_0(string string_1)
	{
		...
		rSACryptoServiceProvider.FromXmlString(global::_003CModule_003E.smethod_8<string>(1370790693u));
	...
	public static string smethod_1(string string_1)
	{
		...
		return string.Join("", source.Select((byte byte_0) => byte_0.ToString(global::_003CModule_003E.smethod_6<string>(2319853163u))));
	}

	public static string smethod_2(string string_1)
	{
		using MD5CryptoServiceProvider mD5CryptoServiceProvider = new MD5CryptoServiceProvider();
		return mD5CryptoServiceProvider.ComputeHash(Encoding.ASCII.GetBytes(string_1)).Aggregate("", (string string_0, byte byte_0) => string_0 + byte_0.ToString(global::_003CModule_003E.smethod_8<string>(3888470923u)));
	}
