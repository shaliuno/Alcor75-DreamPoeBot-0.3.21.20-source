...
internal static class ObjectDependencyManager
{
	...
	public static bool AddObjectDependency(WeakReference weakRefDp, object objToHold)
	{
		...
		if (objToHold == null)
		{
			throw new ArgumentNullException(global::_003CModule_003E.smethod_7<string>(1370703086u), global::_003CModule_003E.smethod_5<string>(285218387u));
		}
		if (!(objToHold.GetType() == typeof(WeakReference)))
		{
			if (weakRefDp.Target == objToHold)
			{
				throw new InvalidOperationException(global::_003CModule_003E.smethod_9<string>(960845382u));
			}
			bool result = false;
		...
		throw new ArgumentException(global::_003CModule_003E.smethod_9<string>(624734682u), global::_003CModule_003E.smethod_7<string>(1370703086u));
	}
	...
	public static void CleanUp(object objToRemove)
	{
		...
		{
			throw new Exception(global::_003CModule_003E.smethod_7<string>(496407167u));
		}
	}
}
