...
internal sealed class LocalizeDictionary : DependencyObject, INotifyPropertyChanged
{
		...
		internal static void smethod_2(IDictionaryEventListener idictionaryEventListener_0)
		{
			...
			lock (obj)
			{
				foreach (WeakReference item in list_0.ToList())
				{
					...
					else if ((IDictionaryEventListener)target == idictionaryEventListener_0)
					{
						list_0.Remove(item);
					}
				}
	...
	internal class Class91 : ICommand
	{
		...
		public Class91(Action<CultureInfo> execute, Predicate<CultureInfo> canExecute)
		{
			if (execute == null)
			{
				throw new ArgumentNullException(global::_003CModule_003E.smethod_8<string>(4198488449u));
			}
			action_0 = execute;
	...
	public static readonly DependencyProperty DefaultProviderProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_5<string>(896269880u), typeof(ILocalizationProvider), typeof(LocalizeDictionary), new PropertyMetadata(null, smethod_4));

	public static readonly DependencyProperty ProviderProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_5<string>(3309598919u), typeof(ILocalizationProvider), typeof(LocalizeDictionary), new PropertyMetadata(null, smethod_1));

	[DesignOnly(true)]
	public static readonly DependencyProperty DesignCultureProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_9<string>(2178281941u), typeof(string), typeof(LocalizeDictionary), new PropertyMetadata(smethod_0));

	public static readonly DependencyProperty SeparationProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_6<string>(3141787544u), typeof(string), typeof(LocalizeDictionary), new PropertyMetadata(DefaultSeparation, smethod_5));

	public static readonly DependencyProperty IncludeInvariantCultureProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_5<string>(2279370187u), typeof(bool), typeof(LocalizeDictionary), new PropertyMetadata(true, smethod_6));

	public static readonly DependencyProperty DisableCacheProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_7<string>(2515775211u), typeof(bool), typeof(LocalizeDictionary), new PropertyMetadata(false, smethod_7));

	public static readonly DependencyProperty OutputMissingKeysProperty = DependencyProperty.RegisterAttached(global::_003CModule_003E.smethod_5<string>(4169296652u), typeof(bool), typeof(LocalizeDictionary), new PropertyMetadata(false, smethod_8));
	...
	public static string DefaultSeparation => global::_003CModule_003E.smethod_9<string>(450936668u);
	...
	public CultureInfo Culture
	{
		...
		set
		{
			...
			if (!GetIsInDesignMode())
			{
				foreach (CultureInfo mergedAvailableCulture in MergedAvailableCultures)
				{
					if (mergedAvailableCulture != CultureInfo.InvariantCulture || IncludeInvariantCulture)
					{
						...
						else if (value.Parent.Name == mergedAvailableCulture.Name)
						{
							cultureInfo = value;
						}
					}
			...
			if (cultureInfo_0 != cultureInfo)
			{
				...
				method_0(global::_003CModule_003E.smethod_6<string>(4036824516u));
			}
		}
	}
	...
	public bool SetCurrentThreadCulture
	{
		...
		set
		{
			...
			{
				bool_3 = value;
				method_0(global::_003CModule_003E.smethod_6<string>(3838174715u));
			}
		}
	}
	...
	{
		return GetLocalizedObject(source + global::_003CModule_003E.smethod_7<string>(2781543372u) + dictionary + global::_003CModule_003E.smethod_7<string>(2781543372u) + key, null, culture, DefaultProvider);
	}
	...
	public object GetLocalizedObject(string key, DependencyObject target, CultureInfo culture, ILocalizationProvider provider)
	{
		if (provider == null)
		{
			throw new InvalidOperationException(global::_003CModule_003E.smethod_9<string>(2857187880u));
		}
	...
	public FullyQualifiedResourceKeyBase GetFullyQualifiedResourceKey(string key, DependencyObject target, ILocalizationProvider provider)
	{
		if (provider == null)
		{
			throw new InvalidOperationException(global::_003CModule_003E.smethod_8<string>(2436112288u));
		}
	...
	public bool ResourceKeyExists(string resourceAssembly, string resourceDictionary, string resourceKey, CultureInfo cultureToUse)
	{
		...
		return ResourceKeyExists(resourceAssembly + global::_003CModule_003E.smethod_6<string>(1084412678u) + resourceDictionary + global::_003CModule_003E.smethod_7<string>(2781543372u) + resourceKey, cultureToUse, instance);
	}
